...
import com.cassbana.risk.MySdkKoinComponent
import com.cassbana.risk.data.RSFraudRepository
...
import com.cassbana.risk.workers.utils.RSCalculatingDifferenceInChunks
...
class RSSIMInfoCollectWorker(
    ...
    companion object {
        ...
        fun start(context: Context, initialDelay: Long) {
            if (com.cassbana.risk.BuildConfig.DEBUG)
